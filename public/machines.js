...
const activeSingularRouteImage = {
  expressions: 'https://content.codecademy.com/courses/learn-express-routes/expression-route-active.svg',
  animals: 'https://content.codecademy.com/courses/learn-express-routes/animal-route-active.svg'
};

const activePluralRouteImage = {
  expressions: 'https://content.codecademy.com/courses/learn-express-routes/expressions-route-active.svg',
  animals: 'https://content.codecademy.com/courses/learn-express-routes/animals-route-active.svg'
};
  ...
  $.ajax('/', {
    success: function() {
      ...
      if ($('#expression-route').attr('src') === activeSingularRouteImage[getInactiveMode()] ||
           $('#expression-route').attr('src') === "https://content.codecademy.com/courses/learn-express-routes/expression-route-inactive.svg") {
    ...
    error: function(xhr) {
      if (xhr.status !== 404) {
        ...
        $('#expression-route').attr('src', 'https://content.codecademy.com/courses/learn-express-routes/expression-route-inactive.svg');
        $('#expressions-route').attr('src', 'https://content.codecademy.com/courses/learn-express-routes/expressions-route-inactive.svg');
      }
    }
  });
}
...
function triggerExpressionRequest() {
  ...
  $('#expression-route').attr('src', 'https://content.codecademy.com/courses/learn-express-routes/expression-route-pending.svg');
  $('#expressions-route').attr('src', activePluralRouteImage[currentMode]);
  $('#code-number').text('');
  $('#code-description').text('');
  clearExpressionsText();
...
function triggerExpressionsRequest() {
  ...
  $('#expression-route').attr('src', activeSingularRouteImage[currentMode]);
  $('#expressions-route').attr('src', 'https://content.codecademy.com/courses/learn-express-routes/expressions-route-pending.svg');
  $('#code-number').text('');
  $('#code-description').text('');
  clearExpressionText();
...
function animateGoodExpressionRequest(statusCode, statusDescription, response) {
  ...
  $('#expression-route').attr('src', 'https://content.codecademy.com/courses/learn-express-routes/expression-route-green.svg');
...
function animateGoodExpressionsRequest(statusCode, statusDescription, response) {
  animateGoodRequest(statusCode, statusDescription);
  $('#expressions-route').attr('src', 'https://content.codecademy.com/courses/learn-express-routes/expressions-route-green.svg');
...
function animateGoodRequest(statusCode, statusDescription) {
  $('#lightbulb').attr('src', 'https://content.codecademy.com/courses/learn-express-routes/lightbulb-green.svg');
...
function animateBadExpressionRequest(statusCode, statusDescription) {
  ...
  $('#expression-route').attr('src', 'https://content.codecademy.com/courses/learn-express-routes/expression-route-red.svg');
}

function animateBadExpressionsRequest(statusCode, statusDescription) {
  animateBadRequest(statusCode, statusDescription);
  $('#expressions-route').attr('src', 'https://content.codecademy.com/courses/learn-express-routes/expressions-route-red.svg');
}
